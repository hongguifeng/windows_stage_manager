...
std::wstring_view chinese_text(UiText text) noexcept
{
    ...
    case UiText::UnsatisfiableTitle: return L"\u7a97\u53e3\u5e03\u5c40\u6682\u65f6\u65e0\u89e3";
    case UiText::UnsatisfiableMessage: return L"\u5f53\u524d\u7a7a\u95f4\u65e0\u6cd5\u8fdb\u4e00\u6b65\u9732\u51fa\u540e\u53f0\u7a97\u53e3\u3002\u7a0b\u5e8f\u672a\u6539\u53d8\u7a97\u53e3\u5c42\u7ea7\uff0c\u5c06\u5728\u7a97\u53e3\u72b6\u6001\u53d8\u5316\u540e\u91cd\u8bd5\u3002";
...
std::wstring_view english_text(UiText text) noexcept
{
    ...
    case UiText::UnsatisfiableTitle: return L"No window layout is currently available";
    case UiText::UnsatisfiableMessage: return L"There is not enough space to expose more background windows. Window Z-order was not changed; the app will retry after window state changes.";
