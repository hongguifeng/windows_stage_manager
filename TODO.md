...
- [ ] M0-01 初始化 CMake/C++20 工程、Debug/Release 构建和测试 runner。commit: 
...
- [ ] M6-01 实现 SetWindowPos 应用、内部事件抑制和后验验证。commit: 
